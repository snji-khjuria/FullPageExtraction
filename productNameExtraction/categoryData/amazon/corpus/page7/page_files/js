...
,
"USED_AND_NEW_FROM":'<a href=\'/gp/offer-listing/#{ASIN}/ref=rdr_ext_uan\' id=\'sitbReaderUsedCount\'> #{COUNT} offer(s)</a> from <span id=\'sitbReaderUsedPrice\' class=\'sitbReaderPrice\'>#{PRICE}</span>'
,
...
,
"SITB_IMAGE_BASE":'http://g-ecx.images-amazon.com/images/G/31/digital/sitb/reader/v4/201408281709/'
,
"SITB_IMAGE_BASE_SECURE":'https://images-na.ssl-images-amazon.com/images/G/31/digital/sitb/reader/v4/201408281709/'
,
...
,
"END_OF_PREVIEW_BUY":'Enjoyed the preview?<br/><a class="sitb-buy-box" href="#{BUY_ACTION}">Buy now</a><br/>or<br/><a class="sitb-buy-box" href=\'/kindle/dp/#{BUYING_ASIN}/ref=#{REFTAG}\'>See details for this book in the Kindle Store</a>'
,
...
,
"HELP_PAGE":'/gp/help/customer/display.html?nodeId=200829990'
,
...
,
"REL_ED_MSG_KINDLE":'This view is of the #{AUTHORITY_LINK}#{AUTHORITY_YEAR_DISP}#{AUTHORITY_PUB_DISP}. The #{RELATED_LINK}#{RELATED_YEAR_DISP}#{RELATED_PUB_DISP} that you originally viewed is the one you\'ll receive if you click the Buy Now button on the left.'
,
"REL_ED_MSG_KINDLE_WITH_BUTTON_TEXT":'This view is of the #{AUTHORITY_LINK}#{AUTHORITY_YEAR_DISP}#{AUTHORITY_PUB_DISP}. The #{RELATED_LINK}#{RELATED_YEAR_DISP}#{RELATED_PUB_DISP} that you originally viewed is the one you\'ll receive if you click #{BUY_BUTTON_TEXT} button on the left.'
,
...
,
"kcp_sitb_getfreeapp_ebooks":''
,
"kcp_sitb_getfreeapp_pbooks":''
,
...
,
"kcp_sitb_widget_width":''
,
"BUY_WITH_1_CLICK":'Buy Now'
,
"PREORDER_WITH_1_CLICK":'Pre-order Now'
,
"ADDITIONAL_BUY_WITH_1_CLICK":'Buy Now'
,
"END_OF_PREVIEW_BUY_DUAL":''
,
"NEW_FROM":''
,
